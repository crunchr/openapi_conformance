...
class OpenAPIConformance:
    ...
    def check_specification_conformance(self):
        ...
        :param send_request: Callable to invoke the implementation.
        """
        for operation in operations(self.specification):
    ...
    def _make_request(self, operation, parameters=None, request_body=None):
        ...
        # TODO: What to use for URL here?
        request = MockRequest(f"http://host.com/", operation.http_method, path)
        return request, self.send_request(request, parameters, request_body)
